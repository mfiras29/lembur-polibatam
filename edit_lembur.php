<?php 
    ...
    $input = mysqli_query($koneksi,"UPDATE form_lembur SET tanggal='$tanggal',jam_mulai='$jam_mulai', jam_selesai='$jam_selesai', keterangan='$keterangan' where id_form_lembur='$id'") or die(mysqli_error($koneksi));
    if($input){
