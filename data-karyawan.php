...
<body>
    ...
    <?php include 'template/sidebar.php'; ?>
        <div class="col-md-10 p-5 pt-2">
            ...
            <a href="form-tambah-karyawan.php" class="btn btn-info btn-sm active mb-2"> <i class="fas fa-plus-circle mr-2"></i>Add Data Karyawan</a>
            <?php } ?>
          ...
          <?php
            if($_SESSION['role'] == 'Bagian Keuangan'){
                $query = "SELECT * FROM user as u INNER JOIN  jabatan as j on u.jabatan = j.id_jabatan";
            }else{
                $query = "SELECT * FROM user as u INNER JOIN  jabatan as j on u.jabatan = j.id_jabatan where u.jurusan =  '".$_SESSION['jurusan']."'";
            }
