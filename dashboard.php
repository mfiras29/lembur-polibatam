...
<body>
    <!-- masukin sidebar -->
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" style="background-color: #14668f">
...
<div class="row no-gutters mt-5">
        <div class="col-md-2 bg-dark mt-2 pr-3 pt-4">
            ...
            <ul class="nav flex-column ml-3 mb-5">
                ...
                <?php if($_SESSION['role'] == 'Kepala Unit' || $_SESSION['role'] == 'Karyawan' ){?>
                    <li class="nav-item">
                ...
                <?php  echo"<li class='nav-item'>
                    <a class='nav-link text-white' href='absen.php'><i class='fas fa-table mr-2'></i>Absen</a>
                    <hr class='bg-secondary'>
                </li>";} ?>
                <?php if($_SESSION['role'] == 'Kepala Unit'){?>
                
                <?php  echo"<li class='nav-item'>
                    <a class='nav-link text-white' href='detail_absen.php'><i class='fas fa-table mr-2'></i>Data Absen</a>
                    <hr class='bg-secondary'>
                </li>";} ?>
...
if($(window).width() < 700){
  //append to the p  
  $('.card mt-5 ml-5').appendTo('#d-flex flex-column');
}
            </script>                                        
